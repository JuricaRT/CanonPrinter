	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}		
					...
					\noindent \underbar{\textbf{UC10 -Učenje upitom engleske riječi uz odabir hrvatskog prijevoda}}
					\begin{packed_item}
	
						\item \textbf{Glavni sudionik: }Učenik
						\item  \textbf{Cilj:} Učiti prijevod engleske riječi na hrvatski jezik
						\item  \textbf{Sudionici:} Baza podataka
						...
						\item[] \begin{packed_enum}
							...
							\item Učeniku se zadaje engleska riječ iz odabranog rječnika i ponuđeni odgovori istoznačne hrvatske riječi
					...
					\noindent \underbar{\textbf{UC11 - Učenje upitom hrvatske riječi uz odabir engleskog prijevoda}}
					\begin{packed_item}
	
						\item \textbf{Glavni sudionik: }Učenik
						\item  \textbf{Cilj:} Učiti prijevod hrvatske riječi na engleski jezik
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Učenik je pokrenuo proces učenja
						\item  \textbf{Opis osnovnog tijeka:}
						...
						\item[] \begin{packed_enum}
							...
							\item Učeniku se zadaje hrvatska riječ iz odabranog rječnika i ponuđeni odgovori istoznačne engleske riječi
							\item Učenik odabire smatrani točan odgovor
							\item Učenik potvrđuje svoj odgovor
							\item Baza podataka ažurira podatke učenja učenika određenim rječnikom temeljeno na točnosti odgovora
							\item Ponavlja se prvi korak sve dok učenik ne prekine učenje
					...
					\noindent \underbar{\textbf{UC12 - Učenje upitom izgovora engleske riječi uz pisanje riječi na engleskom}}
					\begin{packed_item}
	
						\item \textbf{Glavni sudionik: }Učenik
						\item  \textbf{Cilj:} Učiti točno pisanje engleskih riječi na temelju izgovora
						\item  \textbf{Sudionici:} Baza podataka
						\item  \textbf{Preduvjet:} Učenik je pokrenuo proces učenja
						\item  \textbf{Opis osnovnog tijeka:}
						...
						\item[] \begin{packed_enum}
							...
							\item Učeniku se zadaje glasovni zapis engleske riječi
					...
					\noindent \underbar{\textbf{UC13 - Učenje upitom pisane engleske riječi uz snimanje izgovora}}
					\begin{packed_item}
	
						\item \textbf{Glavni sudionik: }Učenik
						\item  \textbf{Cilj:} Učiti izgovor engleskih riječi na temelju tekstualnog oblika riječi
						\item  \textbf{Sudionici:} Baza podataka, Vanjski ispitni API
						\item  \textbf{Preduvjet:} Učenik je pokrenuo proces učenja
						\item  \textbf{Opis osnovnog tijeka:}
						
						\item[] \begin{packed_enum}
	
							\item Učeniku se zadaje tekstualni zapis engleske riječi
							...
							\item Učenik potvrđuje svoj odgovor
							\item Vanjski ispitni API ocjenjuje točnost izgovora riječi
							\item Baza podataka ažurira podatke učenja učenika određenim rječnikom temeljeno na točnosti odgovora
							\item Ponavlja se prvi korak sve dok učenik ne prekine učenje
						\end{packed_enum}
