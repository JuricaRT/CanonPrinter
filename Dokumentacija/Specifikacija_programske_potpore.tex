				...
				\subsubsection{Opis obrazaca uporabe}		
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Učenik prima potvrdu o registraciji i dobiva inicijalnu lozinku za prijavu u aplikaciju
							\item Učenik se prijavljuje u aplikaciju s inicijalnom lozinkom
							\item Aplikacija zahtijeva od učenika da promijeni lozinku
							\item Učenik upisuje novu lozinku i potvrdu nove lozinke
						...
						\item[] \begin{packed_item}
							...
							\item[] \begin{packed_enum}
								...
								\item Sustav obavještava učenika o unosu krive lozinke
								
							\end{packed_enum}
							\item[6.a] Učenik upisuje krivu potvrdu lozinke
							\item[] \begin{packed_enum}
								
								\item Sustav obavještava učenika da se prvo upisana lozinka i potvrda lozinke ne podudaraju
								
							\end{packed_enum}
							\item[7.a] Učenik ne sprema promjene
							\item[] \begin{packed_enum}
								
								\item Sustav vraća učenika na ponovni upis nove lozinke
